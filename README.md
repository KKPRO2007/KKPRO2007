...
<div align="center" style="background:#000; padding:20px; border-radius:10px; margin:20px 0; max-width:600px; color:#fff; text-align:center; font-family:Arial,sans-serif;">
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr; gap:15px; max-width:600px; margin:0 auto;">
    <div style="background:#111; padding:15px; border-radius:8px; text-align:left;">
      <p style="color:#fff; margin:0 0 8px 0; font-weight:bold;">JavaScript — 48.44%</p>
      <div style="background:#333; border-radius:4px; height:8px; width:100%;">
        <div style="background:#3382ed; height:8px; border-radius:4px; width:48.44%;"></div>
      </div>
    </div>
    <div style="background:#111; padding:15px; border-radius:8px; text-align:left;">
      <p style="color:#fff; margin:0 0 8px 0; font-weight:bold;">CSS — 24.52%</p>
      <div style="background:#333; border-radius:4px; height:8px; width:100%;">
        <div style="background:#3382ed; height:8px; border-radius:4px; width:24.52%;"></div>
      </div>
    </div>
    <div style="background:#111; padding:15px; border-radius:8px; text-align:left;">
      <p style="color:#fff; margin:0 0 8px 0; font-weight:bold;">HTML — 21.40%</p>
      <div style="background:#333; border-radius:4px; height:8px; width:100%;">
        <div style="background:#3382ed; height:8px; border-radius:4px; width:21.40%;"></div>
      </div>
    </div>
    <div style="background:#111; padding:15px; border-radius:8px; text-align:left;">
    ...
    <div style="background:#111; padding:15px; border-radius:8px; text-align:left;">
      <p style="color:#fff; margin:0 0 8px 0; font-weight:bold;">Python — 0.28%</p>
      <div style="background:#333; border-radius:4px; height:8px; width:100%;">
        <div style="background:#3382ed; height:8px; border-radius:4px; width:0.28%;"></div>
      </div>
    </div>
  </div>
</div>
